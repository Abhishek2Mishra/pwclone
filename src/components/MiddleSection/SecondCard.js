...
function SampleNextArrow(props) {
    ...
    return (
      <div
        className={className}
        style={{ ...style, display: "block",bottom:'10px',right:'47%',position:'absolute',marginTop:'250px',borderRadius:'10px', boxShadow:'2px 8px 10px 0 rgba(192, 192, 192, 0.3)' }}
        onClick={onClick}
      />
    );
  }
  ...
  function SamplePrevArrow(props) {
    ...
    return (
      <div
        className={className}
        style={{ ...style, display: "block",bottom:'10px',left:'47%',position:'absolute',marginTop:'250px',borderRadius:'10px', boxShadow:'2px 8px 10px 0 rgba(192, 192, 192, 0.3)'  }}
        onClick={onClick}
      />
    );
  }
const SecondCard = () => {
  ...
  return (
    <>
       <div style={{background: "#FEF9F8"     ,padding:" 0px 130px",height:"700px"}}>
        <Slider {...settings} style={{width:"100%",height:"100%"}}>
        { 
            word.map((iterator)=>{
                return (
                    <div>
                        <div className='bg-white' style={{boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px",marginBottom:"10px",borderRadius:"20px"}}>
                        <div style={{color:"black",position:"relative"}}>
                            <div style={{position:"relative"}}>
                                <img src={iterator.image} style={{width:"100%",height:"100%", borderTopLeftRadius:"20px",borderTopRightRadius:"20px"}}/>
                            </div>
                            <div style={{height:"40px", width:"40px", borderRadius:"15px",position:"absolute",top:"50%",left:"50%",bottom:"50%",right:"50%"}}>
                                <img src='./IMAGE/playbutton2.jpg' style={{height:"100%", width:"100%",borderRadius:"22px"}} />
                            </div>
